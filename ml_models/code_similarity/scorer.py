...
def get_edit_distance_score(answer: str, original: str) -> int:
    ...
    """Return an integer score 0..100 where 100 means identical after normalization.

    Scoring contract:
    - Use normalized lowercase strings
    - Compute a weighted Levenshtein distance where syntax chars cost more
    - Add penalties for logic changes and syntax errors
    - Normalize by the maximum possible cost (max length * max weight)
